    ...
    if (figura == "box"){
        ...
        for(int i =0; i < slices; i++){
            ...
            for(int j=0; j < stacks; j++){
                ...
                outputFile << raio*cos(beta)*sin(alpha) << " " << raio*sin(beta) << " " << raio*cos(beta)*cos(alpha) << endl; // 1
                outputFile << raio*cos(angF)*sin(alpha) << " " << raio*sin(angF) << " " << raio*cos(angF)*cos(alpha) << endl; // 2
